...
export class KiloCodeSettingTab extends PluginSettingTab {
  ...
  private renderContent(containerEl: HTMLElement): void {
    ...
    new Setting(containerEl)
      ...
      .setDesc('Auto-stop KiloCode CLI after this many seconds of inactivity. Set to 0 to keep the process running (not recommended ¡ª wastes tokens). Default: 600s (10 minutes).')
    ...
    new Setting(containerEl)
      ...
      .addDropdown(dropdown => dropdown
        .addOption('normal', 'Normal ¡ª approve write operations')
        .addOption('yolo', 'Yolo ¡ª auto-approve all operations')
        .addOption('plan', 'Plan ¡ª read-only, deny all writes')
  ...
  getSettingDefinitions(): SettingDefinitionItem[] {
    ...
    // CLI Config File ¡ª button to reload
    cliGroup.items!.push({
